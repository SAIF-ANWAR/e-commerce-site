...
const Laptop = ({ laptop }) => {
    ...
    return (
        <div class="max-w-sm bg-white rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
            <a href="#">
                <img class="p-8 rounded-t-lg mx-auto" src={img} alt="" />
            </a>
            <div class="px-5 pb-5">
                <a href="#">
                ...
                <div class="flex justify-between items-center">
                    ...
                    <Link to="" type="button" class="text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 font-medium rounded-lg text-sm px-5 py-2.5 text-center mt-1 mr-2 mb-2">Buy Now</Link>
                </div>
            </div>
