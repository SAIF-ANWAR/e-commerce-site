        ...
        <div class="card lg:card-side bg-base-100 shadow-xl w-3/5 mx-auto p-10">
            ...
            <div class="card-body ">
                ...
                <div class="card-actions justify-center mt-2">
                    <button onClick={() => handleBuyNow(mobile._id)} class="btn text-lg text-white bg-gradient-to-r from-blue-500 via-blue-600 to-blue-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-blue-800 w-full">Buy Now</button>
                </div>
            </div>
        </div>
    );
