                    ...
                    <div class="card  card-compact bg-base-100 shadow-xl">
                        ...
                        <div class="card-body">
                            <ul class="w-full text-sm font-medium text-gray-900 bg-white border border-gray-200 rounded-lg dark:bg-gray-700 dark:border-gray-600 dark:text-white">
                                ...
                                <li class="w-full  px-4 py-2 border-b border-gray-200 dark:border-gray-600">Quantity:  {laptop?.quantity === 0 ? "Out of Stock" : <p className='text-green-400'>In Stock</p>}</li>
                            </ul>
                            <div class="card-actions justify-end py-2">
                                <button onClick={handleDelete} class="btn btn-sm">Delete</button>
                                <button onClick={handleRestock} class="btn btn-sm">Restock</button>
                            </div>
                        </div>
                    </div>
                </div>)
